...
export type CheckoutFragment = { __typename?: 'Checkout' } & Pick<
  Checkout,
  'id' | 'webUrl'
> & {
        ...
        { __typename?: 'CheckoutLineItemEdge' } & {
          ...
          > & {
              variant?: Maybe<
                ...
                > & {
                    image?: Maybe<
                      { __typename?: 'Image' } & Pick<Image, 'transformedSrc'>
                    >
  ...
  edges: Array<
    { __typename?: 'ProductEdge' } & Pick<ProductEdge, 'cursor'> & {
        node: { __typename?: 'Product' } & Pick<
          Product,
          'title' | 'handle' | 'description' | 'createdAt'
        > & {
            images: { __typename?: 'ImageConnection' } & {
              edges: Array<
                { __typename?: 'ImageEdge' } & {
...
`
export type CheckoutCreateMutationFn = ApolloReactCommon.MutationFunction<
...
export function useCheckoutCreateMutation(
  ...
  return ApolloReactHooks.useMutation<
    CheckoutCreateMutation,
    CheckoutCreateMutationVariables
  >(CheckoutCreateDocument, baseOptions)
}
export type CheckoutCreateMutationHookResult = ReturnType<
  typeof useCheckoutCreateMutation
>
export type CheckoutCreateMutationResult = ApolloReactCommon.MutationResult<
  CheckoutCreateMutation
>
export type CheckoutCreateMutationOptions = ApolloReactCommon.BaseMutationOptions<
  CheckoutCreateMutation,
  CheckoutCreateMutationVariables
>
...
export function useCheckoutQuery(
  ...
  return ApolloReactHooks.useQuery<CheckoutQuery, CheckoutQueryVariables>(
    CheckoutDocument,
    baseOptions,
  )
}
export function useCheckoutLazyQuery(
  ...
  return ApolloReactHooks.useLazyQuery<CheckoutQuery, CheckoutQueryVariables>(
    CheckoutDocument,
    baseOptions,
  )
}
...
>
export type CheckoutQueryResult = ApolloReactCommon.QueryResult<
  CheckoutQuery,
  CheckoutQueryVariables
>
export const CheckoutLineItemsReplaceDocument = gql`
  ...
  ${CheckoutFragmentDoc}
`
export type CheckoutLineItemsReplaceMutationFn = ApolloReactCommon.MutationFunction<
 ...
 * });
 */
export function useCheckoutLineItemsReplaceMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    CheckoutLineItemsReplaceMutation,
    CheckoutLineItemsReplaceMutationVariables
  >,
  ...
  return ApolloReactHooks.useMutation<
    CheckoutLineItemsReplaceMutation,
    CheckoutLineItemsReplaceMutationVariables
  >(CheckoutLineItemsReplaceDocument, baseOptions)
}
export type CheckoutLineItemsReplaceMutationHookResult = ReturnType<
  typeof useCheckoutLineItemsReplaceMutation
>
export type CheckoutLineItemsReplaceMutationResult = ApolloReactCommon.MutationResult<
  CheckoutLineItemsReplaceMutation
>
export type CheckoutLineItemsReplaceMutationOptions = ApolloReactCommon.BaseMutationOptions<
  CheckoutLineItemsReplaceMutation,
  CheckoutLineItemsReplaceMutationVariables
>
